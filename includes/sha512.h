...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/26 20:26:48 by gemerald          #+#    #+#             */
/*   Updated: 2021/01/26 20:37:30 by gemerald         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef FT_SSL_MD5_SHA512_H
#define FT_SSL_MD5_SHA512_H

# include <stdlib.h>
#include "libft.h"

static const uint64_t const g_const_512[80] = {
...
void sha512_round(t_handler *hndlr, uint64_t words[], uint64_t round);
